 ...
 * @param optional nil or *WorkflowsApiGetWorkflowsPaginatedOpts - Optional Parameters:
     ...
     * @param "QueryString" (optional.String) -  String used to perform a case-insensitive partial match with workflow name.
     * @param "OrderBy" (optional.String) -  [Order](#ordering) the results by a field:   *  &#x60;name&#x60; Sorts by workflow name.  *  &#x60;created&#x60; Sorts by create time.  *  &#x60;updated&#x60; Sorts by update time.
     * @param "IsActive" (optional.Bool) -  Filters active and inactive workflows.
