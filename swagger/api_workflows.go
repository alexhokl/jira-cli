...
func (r ApiCreateWorkflowRequest) CreateWorkflowDetails(createWorkflowDetails CreateWorkflowDetails) ApiCreateWorkflowRequest {
	r.createWorkflowDetails = &createWorkflowDetails
	return r
}

func (r ApiCreateWorkflowRequest) Execute() (*WorkflowIDs, *http.Response, error) {
...
//  @return WorkflowIDs
// Deprecated
func (a *WorkflowsAPIService) CreateWorkflowExecute(r ApiCreateWorkflowRequest) (*WorkflowIDs, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/rest/api/3/workflow"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createWorkflowDetails == nil {
		return localVarReturnValue, nil, reportError("createWorkflowDetails is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createWorkflowDetails
...
type ApiCreateWorkflowsRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowCreateRequest *WorkflowCreateRequest
}

func (r ApiCreateWorkflowsRequest) WorkflowCreateRequest(workflowCreateRequest WorkflowCreateRequest) ApiCreateWorkflowsRequest {
	r.workflowCreateRequest = &workflowCreateRequest
	return r
}

func (r ApiCreateWorkflowsRequest) Execute() (*WorkflowCreateResponse, *http.Response, error) {
	return r.ApiService.CreateWorkflowsExecute(r)
}

/*
CreateWorkflows Bulk create workflows
 ...
 *  *Administer projects* project permissions to create project-scoped workflows
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateWorkflowsRequest
*/
func (a *WorkflowsAPIService) CreateWorkflows(ctx context.Context) ApiCreateWorkflowsRequest {
	return ApiCreateWorkflowsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) CreateWorkflowsExecute(r ApiCreateWorkflowsRequest) (*WorkflowCreateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowCreateResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.CreateWorkflows")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflows/create"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.workflowCreateRequest == nil {
		return localVarReturnValue, nil, reportError("workflowCreateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.workflowCreateRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiDeleteInactiveWorkflowRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	entityId string
}

func (r ApiDeleteInactiveWorkflowRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteInactiveWorkflowExecute(r)
}
...
**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
 ...
 @return ApiDeleteInactiveWorkflowRequest
*/
func (a *WorkflowsAPIService) DeleteInactiveWorkflow(ctx context.Context, entityId string) ApiDeleteInactiveWorkflowRequest {
	return ApiDeleteInactiveWorkflowRequest{
		ApiService: a,
		ctx: ctx,
		entityId: entityId,
...
// Execute executes the request
func (a *WorkflowsAPIService) DeleteInactiveWorkflowExecute(r ApiDeleteInactiveWorkflowRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.DeleteInactiveWorkflow")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflow/{entityId}"
...
func (r ApiGetAllWorkflowsRequest) WorkflowName(workflowName string) ApiGetAllWorkflowsRequest {
	r.workflowName = &workflowName
	return r
}

func (r ApiGetAllWorkflowsRequest) Execute() ([]DeprecatedWorkflow, *http.Response, error) {
...
// Deprecated
func (a *WorkflowsAPIService) GetAllWorkflowsExecute(r ApiGetAllWorkflowsRequest) ([]DeprecatedWorkflow, *http.Response, error) {
	var (
...
type ApiGetDefaultEditorRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
}

func (r ApiGetDefaultEditorRequest) Execute() (*DefaultWorkflowEditorResponse, *http.Response, error) {
	return r.ApiService.GetDefaultEditorExecute(r)
}

/*
GetDefaultEditor Get the user's default workflow editor

Get the user's default workflow editor. This can be either the new editor or the legacy editor.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetDefaultEditorRequest
*/
func (a *WorkflowsAPIService) GetDefaultEditor(ctx context.Context) ApiGetDefaultEditorRequest {
	return ApiGetDefaultEditorRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) GetDefaultEditorExecute(r ApiGetDefaultEditorRequest) (*DefaultWorkflowEditorResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DefaultWorkflowEditorResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.GetDefaultEditor")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflows/defaultEditor"
...
type ApiGetProjectUsagesForWorkflowRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowId string
...
func (r ApiGetProjectUsagesForWorkflowRequest) NextPageToken(nextPageToken string) ApiGetProjectUsagesForWorkflowRequest {
	r.nextPageToken = &nextPageToken
	return r
}

// The maximum number of results to return. Must be an integer between 1 and 200.
func (r ApiGetProjectUsagesForWorkflowRequest) MaxResults(maxResults int32) ApiGetProjectUsagesForWorkflowRequest {
	r.maxResults = &maxResults
	return r
}

func (r ApiGetProjectUsagesForWorkflowRequest) Execute() (*WorkflowProjectUsageDTO, *http.Response, error) {
	return r.ApiService.GetProjectUsagesForWorkflowExecute(r)
}

/*
GetProjectUsagesForWorkflow Get projects using a given workflow

Returns a page of projects using a given workflow.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param workflowId The workflow ID
 @return ApiGetProjectUsagesForWorkflowRequest
*/
func (a *WorkflowsAPIService) GetProjectUsagesForWorkflow(ctx context.Context, workflowId string) ApiGetProjectUsagesForWorkflowRequest {
	return ApiGetProjectUsagesForWorkflowRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *WorkflowsAPIService) GetProjectUsagesForWorkflowExecute(r ApiGetProjectUsagesForWorkflowRequest) (*WorkflowProjectUsageDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowProjectUsageDTO
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.GetProjectUsagesForWorkflow")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflow/{workflowId}/projectUsages"
...
type ApiGetWorkflowProjectIssueTypeUsagesRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowId string
	projectId int64
...
// The cursor for pagination
func (r ApiGetWorkflowProjectIssueTypeUsagesRequest) NextPageToken(nextPageToken string) ApiGetWorkflowProjectIssueTypeUsagesRequest {
	r.nextPageToken = &nextPageToken
	return r
}

// The maximum number of results to return. Must be an integer between 1 and 200.
func (r ApiGetWorkflowProjectIssueTypeUsagesRequest) MaxResults(maxResults int32) ApiGetWorkflowProjectIssueTypeUsagesRequest {
	r.maxResults = &maxResults
	return r
}

func (r ApiGetWorkflowProjectIssueTypeUsagesRequest) Execute() (*WorkflowProjectIssueTypeUsageDTO, *http.Response, error) {
	return r.ApiService.GetWorkflowProjectIssueTypeUsagesExecute(r)
}

/*
GetWorkflowProjectIssueTypeUsages Get issue types in a project that are using a given workflow
...
Returns a page of issue types using a given workflow within a project.
 ...
 @return ApiGetWorkflowProjectIssueTypeUsagesRequest
*/
func (a *WorkflowsAPIService) GetWorkflowProjectIssueTypeUsages(ctx context.Context, workflowId string, projectId int64) ApiGetWorkflowProjectIssueTypeUsagesRequest {
	return ApiGetWorkflowProjectIssueTypeUsagesRequest{
		ApiService: a,
		ctx: ctx,
		workflowId: workflowId,
...
func (a *WorkflowsAPIService) GetWorkflowProjectIssueTypeUsagesExecute(r ApiGetWorkflowProjectIssueTypeUsagesRequest) (*WorkflowProjectIssueTypeUsageDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowProjectIssueTypeUsageDTO
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.GetWorkflowProjectIssueTypeUsages")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflow/{workflowId}/project/{projectId}/issueTypeUsages"
	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", url.PathEscape(parameterValueToString(r.workflowId, "workflowId")), -1)
...
type ApiGetWorkflowSchemeUsagesForWorkflowRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowId string
	nextPageToken *string
...
// The cursor for pagination
func (r ApiGetWorkflowSchemeUsagesForWorkflowRequest) NextPageToken(nextPageToken string) ApiGetWorkflowSchemeUsagesForWorkflowRequest {
	r.nextPageToken = &nextPageToken
	return r
}

// The maximum number of results to return. Must be an integer between 1 and 200.
func (r ApiGetWorkflowSchemeUsagesForWorkflowRequest) MaxResults(maxResults int32) ApiGetWorkflowSchemeUsagesForWorkflowRequest {
	r.maxResults = &maxResults
	return r
}

func (r ApiGetWorkflowSchemeUsagesForWorkflowRequest) Execute() (*WorkflowSchemeUsageDTO, *http.Response, error) {
	return r.ApiService.GetWorkflowSchemeUsagesForWorkflowExecute(r)
}

/*
GetWorkflowSchemeUsagesForWorkflow Get workflow schemes which are using a given workflow

Returns a page of workflow schemes using a given workflow.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param workflowId The workflow ID
 @return ApiGetWorkflowSchemeUsagesForWorkflowRequest
*/
func (a *WorkflowsAPIService) GetWorkflowSchemeUsagesForWorkflow(ctx context.Context, workflowId string) ApiGetWorkflowSchemeUsagesForWorkflowRequest {
	return ApiGetWorkflowSchemeUsagesForWorkflowRequest{
		ApiService: a,
		ctx: ctx,
		workflowId: workflowId,
...
func (a *WorkflowsAPIService) GetWorkflowSchemeUsagesForWorkflowExecute(r ApiGetWorkflowSchemeUsagesForWorkflowRequest) (*WorkflowSchemeUsageDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowSchemeUsageDTO
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.GetWorkflowSchemeUsagesForWorkflow")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflow/{workflowId}/workflowSchemes"
	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", url.PathEscape(parameterValueToString(r.workflowId, "workflowId")), -1)
...
type ApiGetWorkflowsPaginatedRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	startAt *int64
	maxResults *int32
...
func (r ApiGetWorkflowsPaginatedRequest) StartAt(startAt int64) ApiGetWorkflowsPaginatedRequest {
	r.startAt = &startAt
	return r
}

// The maximum number of items to return per page.
func (r ApiGetWorkflowsPaginatedRequest) MaxResults(maxResults int32) ApiGetWorkflowsPaginatedRequest {
	r.maxResults = &maxResults
	return r
}
...
func (r ApiGetWorkflowsPaginatedRequest) WorkflowName(workflowName []string) ApiGetWorkflowsPaginatedRequest {
	r.workflowName = &workflowName
	return r
}
...
func (r ApiGetWorkflowsPaginatedRequest) Expand(expand string) ApiGetWorkflowsPaginatedRequest {
	r.expand = &expand
	return r
}

// String used to perform a case-insensitive partial match with workflow name.
func (r ApiGetWorkflowsPaginatedRequest) QueryString(queryString string) ApiGetWorkflowsPaginatedRequest {
...
func (r ApiGetWorkflowsPaginatedRequest) OrderBy(orderBy string) ApiGetWorkflowsPaginatedRequest {
	r.orderBy = &orderBy
	return r
}

// Filters active and inactive workflows.
func (r ApiGetWorkflowsPaginatedRequest) IsActive(isActive bool) ApiGetWorkflowsPaginatedRequest {
	r.isActive = &isActive
	return r
}

func (r ApiGetWorkflowsPaginatedRequest) Execute() (*PageBeanWorkflow, *http.Response, error) {
	return r.ApiService.GetWorkflowsPaginatedExecute(r)
}
...
**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetWorkflowsPaginatedRequest

Deprecated
*/
func (a *WorkflowsAPIService) GetWorkflowsPaginated(ctx context.Context) ApiGetWorkflowsPaginatedRequest {
	return ApiGetWorkflowsPaginatedRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *WorkflowsAPIService) GetWorkflowsPaginatedExecute(r ApiGetWorkflowsPaginatedRequest) (*PageBeanWorkflow, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.GetWorkflowsPaginated")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflow/search"
	...
	if r.workflowName != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "workflowName", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "workflowName", t, "form", "multi")
		}
	}
	if r.expand != nil {
...
type ApiListWorkflowHistoryRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
...
func (r ApiListWorkflowHistoryRequest) WorkflowHistoryListRequest(workflowHistoryListRequest WorkflowHistoryListRequest) ApiListWorkflowHistoryRequest {
	r.workflowHistoryListRequest = &workflowHistoryListRequest
	return r
}
...
func (r ApiListWorkflowHistoryRequest) Expand(expand string) ApiListWorkflowHistoryRequest {
	r.expand = &expand
	return r
}

func (r ApiListWorkflowHistoryRequest) Execute() (*WorkflowHistoryListResponseDTO, *http.Response, error) {
	return r.ApiService.ListWorkflowHistoryExecute(r)
}

/*
ListWorkflowHistory List workflow history entries
 ...
 *  At least one of the *Administer projects* and *View (read-only) workflow* project permissions to access project-scoped workflows
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListWorkflowHistoryRequest
*/
func (a *WorkflowsAPIService) ListWorkflowHistory(ctx context.Context) ApiListWorkflowHistoryRequest {
	return ApiListWorkflowHistoryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) ListWorkflowHistoryExecute(r ApiListWorkflowHistoryRequest) (*WorkflowHistoryListResponseDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowHistoryListResponseDTO
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.ListWorkflowHistory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflow/history/list"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.workflowHistoryListRequest == nil {
		return localVarReturnValue, nil, reportError("workflowHistoryListRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.workflowHistoryListRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiReadWorkflowFromHistoryRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowHistoryReadRequest *WorkflowHistoryReadRequest
}

func (r ApiReadWorkflowFromHistoryRequest) WorkflowHistoryReadRequest(workflowHistoryReadRequest WorkflowHistoryReadRequest) ApiReadWorkflowFromHistoryRequest {
	r.workflowHistoryReadRequest = &workflowHistoryReadRequest
	return r
}

func (r ApiReadWorkflowFromHistoryRequest) Execute() (*WorkflowHistoryReadResponseDTO, *http.Response, error) {
	return r.ApiService.ReadWorkflowFromHistoryExecute(r)
}

/*
ReadWorkflowFromHistory Read workflow version from history
 ...
 *  At least one of the *Administer projects* and *View (read-only) workflow* project permissions to access project-scoped workflows
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReadWorkflowFromHistoryRequest
*/
func (a *WorkflowsAPIService) ReadWorkflowFromHistory(ctx context.Context) ApiReadWorkflowFromHistoryRequest {
	return ApiReadWorkflowFromHistoryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) ReadWorkflowFromHistoryExecute(r ApiReadWorkflowFromHistoryRequest) (*WorkflowHistoryReadResponseDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowHistoryReadResponseDTO
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.ReadWorkflowFromHistory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflow/history"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.workflowHistoryReadRequest == nil {
		return localVarReturnValue, nil, reportError("workflowHistoryReadRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.workflowHistoryReadRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiReadWorkflowPreviewsRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowPreviewRequest *WorkflowPreviewRequest
}

func (r ApiReadWorkflowPreviewsRequest) WorkflowPreviewRequest(workflowPreviewRequest WorkflowPreviewRequest) ApiReadWorkflowPreviewsRequest {
	r.workflowPreviewRequest = &workflowPreviewRequest
	return r
}

func (r ApiReadWorkflowPreviewsRequest) Execute() (*WorkflowPreviewResponse, *http.Response, error) {
	return r.ApiService.ReadWorkflowPreviewsExecute(r)
}

/*
ReadWorkflowPreviews Preview workflow
 ...
 *  At least one of the *Administer projects* and *View (read-only) workflow* project permissions
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReadWorkflowPreviewsRequest
*/
func (a *WorkflowsAPIService) ReadWorkflowPreviews(ctx context.Context) ApiReadWorkflowPreviewsRequest {
	return ApiReadWorkflowPreviewsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) ReadWorkflowPreviewsExecute(r ApiReadWorkflowPreviewsRequest) (*WorkflowPreviewResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowPreviewResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.ReadWorkflowPreviews")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflows/preview"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.workflowPreviewRequest == nil {
		return localVarReturnValue, nil, reportError("workflowPreviewRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.workflowPreviewRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiReadWorkflowsRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowReadRequest *WorkflowReadRequest
}

func (r ApiReadWorkflowsRequest) WorkflowReadRequest(workflowReadRequest WorkflowReadRequest) ApiReadWorkflowsRequest {
	r.workflowReadRequest = &workflowReadRequest
	return r
}

func (r ApiReadWorkflowsRequest) Execute() (*WorkflowReadResponse, *http.Response, error) {
	return r.ApiService.ReadWorkflowsExecute(r)
}

/*
ReadWorkflows Bulk get workflows
 ...
 *  At least one of the *Administer projects* and *View (read-only) workflow* project permissions to access project-scoped workflows
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReadWorkflowsRequest
*/
func (a *WorkflowsAPIService) ReadWorkflows(ctx context.Context) ApiReadWorkflowsRequest {
	return ApiReadWorkflowsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) ReadWorkflowsExecute(r ApiReadWorkflowsRequest) (*WorkflowReadResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowReadResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.ReadWorkflows")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflows"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.workflowReadRequest == nil {
		return localVarReturnValue, nil, reportError("workflowReadRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.workflowReadRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
// The index of the first item to return in a page of results (page offset).
func (r ApiSearchWorkflowsRequest) StartAt(startAt int64) ApiSearchWorkflowsRequest {
	r.startAt = &startAt
	return r
}

// The maximum number of items to return per page.
func (r ApiSearchWorkflowsRequest) MaxResults(maxResults int32) ApiSearchWorkflowsRequest {
	r.maxResults = &maxResults
	return r
}
...
func (r ApiSearchWorkflowsRequest) Expand(expand string) ApiSearchWorkflowsRequest {
	r.expand = &expand
	return r
}

// String used to perform a case-insensitive partial match with workflow name.
func (r ApiSearchWorkflowsRequest) QueryString(queryString string) ApiSearchWorkflowsRequest {
	r.queryString = &queryString
	return r
}

// [Order](#ordering) the results by a field:   *  &#x60;name&#x60; Sorts by workflow name.  *  &#x60;created&#x60; Sorts by create time.  *  &#x60;updated&#x60; Sorts by update time.
func (r ApiSearchWorkflowsRequest) OrderBy(orderBy string) ApiSearchWorkflowsRequest {
	r.orderBy = &orderBy
	return r
}

// The scope of the workflow. Global for company-managed projects and Project for team-managed projects.
func (r ApiSearchWorkflowsRequest) Scope(scope string) ApiSearchWorkflowsRequest {
	r.scope = &scope
	return r
}

// Filters active and inactive workflows.
func (r ApiSearchWorkflowsRequest) IsActive(isActive bool) ApiSearchWorkflowsRequest {
	r.isActive = &isActive
	return r
}

func (r ApiSearchWorkflowsRequest) Execute() (*WorkflowSearchResponse, *http.Response, error) {
...
func (a *WorkflowsAPIService) SearchWorkflowsExecute(r ApiSearchWorkflowsRequest) (*WorkflowSearchResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/rest/api/3/workflows/search"
...
func (r ApiUpdateWorkflowsRequest) WorkflowUpdateRequest(workflowUpdateRequest WorkflowUpdateRequest) ApiUpdateWorkflowsRequest {
	r.workflowUpdateRequest = &workflowUpdateRequest
	return r
}

func (r ApiUpdateWorkflowsRequest) Execute() (*WorkflowUpdateResponse, *http.Response, error) {
	return r.ApiService.UpdateWorkflowsExecute(r)
}

/*
UpdateWorkflows Bulk update workflows
...
*/
func (a *WorkflowsAPIService) UpdateWorkflows(ctx context.Context) ApiUpdateWorkflowsRequest {
	return ApiUpdateWorkflowsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) UpdateWorkflowsExecute(r ApiUpdateWorkflowsRequest) (*WorkflowUpdateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.UpdateWorkflows")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflows/update"
...
type ApiValidateCreateWorkflowsRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowCreateValidateRequest *WorkflowCreateValidateRequest
}

func (r ApiValidateCreateWorkflowsRequest) WorkflowCreateValidateRequest(workflowCreateValidateRequest WorkflowCreateValidateRequest) ApiValidateCreateWorkflowsRequest {
	r.workflowCreateValidateRequest = &workflowCreateValidateRequest
	return r
}

func (r ApiValidateCreateWorkflowsRequest) Execute() (*WorkflowValidationErrorList, *http.Response, error) {
	return r.ApiService.ValidateCreateWorkflowsExecute(r)
}
 ...
 *  *Administer projects* project permissions to create project-scoped workflows
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiValidateCreateWorkflowsRequest
*/
func (a *WorkflowsAPIService) ValidateCreateWorkflows(ctx context.Context) ApiValidateCreateWorkflowsRequest {
	return ApiValidateCreateWorkflowsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) ValidateCreateWorkflowsExecute(r ApiValidateCreateWorkflowsRequest) (*WorkflowValidationErrorList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowValidationErrorList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.ValidateCreateWorkflows")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflows/create/validation"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.workflowCreateValidateRequest == nil {
		return localVarReturnValue, nil, reportError("workflowCreateValidateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.workflowCreateValidateRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiValidateUpdateWorkflowsRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowUpdateValidateRequestBean *WorkflowUpdateValidateRequestBean
}

func (r ApiValidateUpdateWorkflowsRequest) WorkflowUpdateValidateRequestBean(workflowUpdateValidateRequestBean WorkflowUpdateValidateRequestBean) ApiValidateUpdateWorkflowsRequest {
	r.workflowUpdateValidateRequestBean = &workflowUpdateValidateRequestBean
	return r
}

func (r ApiValidateUpdateWorkflowsRequest) Execute() (*WorkflowValidationErrorList, *http.Response, error) {
	return r.ApiService.ValidateUpdateWorkflowsExecute(r)
}
 ...
 *  *Administer projects* project permissions to create project-scoped workflows
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiValidateUpdateWorkflowsRequest
*/
func (a *WorkflowsAPIService) ValidateUpdateWorkflows(ctx context.Context) ApiValidateUpdateWorkflowsRequest {
	return ApiValidateUpdateWorkflowsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return WorkflowValidationErrorList
func (a *WorkflowsAPIService) ValidateUpdateWorkflowsExecute(r ApiValidateUpdateWorkflowsRequest) (*WorkflowValidationErrorList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.ValidateUpdateWorkflows")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflows/update/validation"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.workflowUpdateValidateRequestBean == nil {
		return localVarReturnValue, nil, reportError("workflowUpdateValidateRequestBean is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.workflowUpdateValidateRequestBean
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiWorkflowCapabilitiesRequest struct {
	ctx context.Context
	ApiService *WorkflowsAPIService
	workflowId *string
	projectId *string
...
func (r ApiWorkflowCapabilitiesRequest) WorkflowId(workflowId string) ApiWorkflowCapabilitiesRequest {
	r.workflowId = &workflowId
	return r
}

func (r ApiWorkflowCapabilitiesRequest) ProjectId(projectId string) ApiWorkflowCapabilitiesRequest {
	r.projectId = &projectId
	return r
}

func (r ApiWorkflowCapabilitiesRequest) IssueTypeId(issueTypeId string) ApiWorkflowCapabilitiesRequest {
	r.issueTypeId = &issueTypeId
	return r
}

func (r ApiWorkflowCapabilitiesRequest) Execute() (*WorkflowCapabilities, *http.Response, error) {
	return r.ApiService.WorkflowCapabilitiesExecute(r)
}

/*
WorkflowCapabilities Get available workflow capabilities
 ...
 *  `tag` additional tags for the Forge app
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiWorkflowCapabilitiesRequest
*/
func (a *WorkflowsAPIService) WorkflowCapabilities(ctx context.Context) ApiWorkflowCapabilitiesRequest {
	return ApiWorkflowCapabilitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowsAPIService) WorkflowCapabilitiesExecute(r ApiWorkflowCapabilitiesRequest) (*WorkflowCapabilities, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowCapabilities
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsAPIService.WorkflowCapabilities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/rest/api/3/workflows/capabilities"
