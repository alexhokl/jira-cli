...
// checks if the PageBeanSecurityLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanSecurityLevel{}
...
// SetValues gets a reference to the given []SecurityLevel and assigns it to the Values field.
func (o *PageBeanSecurityLevel) SetValues(v []SecurityLevel) {
	o.Values = v
}

func (o PageBeanSecurityLevel) MarshalJSON() ([]byte, error) {
...
func (o PageBeanSecurityLevel) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanSecurityLevel struct {
	value *PageBeanSecurityLevel
	isSet bool
}

func (v NullablePageBeanSecurityLevel) Get() *PageBeanSecurityLevel {
	return v.value
}

func (v *NullablePageBeanSecurityLevel) Set(val *PageBeanSecurityLevel) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanSecurityLevel) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanSecurityLevel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanSecurityLevel(val *PageBeanSecurityLevel) *NullablePageBeanSecurityLevel {
	return &NullablePageBeanSecurityLevel{value: val, isSet: true}
}

func (v NullablePageBeanSecurityLevel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanSecurityLevel) UnmarshalJSON(src []byte) error {
	v.isSet = true
