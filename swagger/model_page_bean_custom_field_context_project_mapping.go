...
// checks if the PageBeanCustomFieldContextProjectMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanCustomFieldContextProjectMapping{}
...
func NewPageBeanCustomFieldContextProjectMapping() *PageBeanCustomFieldContextProjectMapping {
	this := PageBeanCustomFieldContextProjectMapping{}
	return &this
}
...
func (o *PageBeanCustomFieldContextProjectMapping) GetValues() []CustomFieldContextProjectMapping {
	if o == nil || IsNil(o.Values) {
		var ret []CustomFieldContextProjectMapping
		return ret
	}
	return o.Values
}
...
// SetValues gets a reference to the given []CustomFieldContextProjectMapping and assigns it to the Values field.
func (o *PageBeanCustomFieldContextProjectMapping) SetValues(v []CustomFieldContextProjectMapping) {
	o.Values = v
}

func (o PageBeanCustomFieldContextProjectMapping) MarshalJSON() ([]byte, error) {
...
func (o PageBeanCustomFieldContextProjectMapping) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanCustomFieldContextProjectMapping struct {
	value *PageBeanCustomFieldContextProjectMapping
	isSet bool
}

func (v NullablePageBeanCustomFieldContextProjectMapping) Get() *PageBeanCustomFieldContextProjectMapping {
	return v.value
}

func (v *NullablePageBeanCustomFieldContextProjectMapping) Set(val *PageBeanCustomFieldContextProjectMapping) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanCustomFieldContextProjectMapping) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanCustomFieldContextProjectMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanCustomFieldContextProjectMapping(val *PageBeanCustomFieldContextProjectMapping) *NullablePageBeanCustomFieldContextProjectMapping {
	return &NullablePageBeanCustomFieldContextProjectMapping{value: val, isSet: true}
}

func (v NullablePageBeanCustomFieldContextProjectMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanCustomFieldContextProjectMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
