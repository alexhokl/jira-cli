...
// checks if the PageBeanCustomFieldContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanCustomFieldContext{}
...
func NewPageBeanCustomFieldContext() *PageBeanCustomFieldContext {
	this := PageBeanCustomFieldContext{}
	return &this
}
...
// SetValues gets a reference to the given []CustomFieldContext and assigns it to the Values field.
func (o *PageBeanCustomFieldContext) SetValues(v []CustomFieldContext) {
	o.Values = v
}

func (o PageBeanCustomFieldContext) MarshalJSON() ([]byte, error) {
...
func (o PageBeanCustomFieldContext) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanCustomFieldContext struct {
	value *PageBeanCustomFieldContext
	isSet bool
}

func (v NullablePageBeanCustomFieldContext) Get() *PageBeanCustomFieldContext {
	return v.value
}

func (v *NullablePageBeanCustomFieldContext) Set(val *PageBeanCustomFieldContext) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanCustomFieldContext) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanCustomFieldContext) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanCustomFieldContext(val *PageBeanCustomFieldContext) *NullablePageBeanCustomFieldContext {
	return &NullablePageBeanCustomFieldContext{value: val, isSet: true}
}

func (v NullablePageBeanCustomFieldContext) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanCustomFieldContext) UnmarshalJSON(src []byte) error {
	v.isSet = true
