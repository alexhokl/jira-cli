...
// checks if the PageBeanContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanContext{}
...
// SetValues gets a reference to the given []Context and assigns it to the Values field.
func (o *PageBeanContext) SetValues(v []Context) {
	o.Values = v
}

func (o PageBeanContext) MarshalJSON() ([]byte, error) {
...
func (o PageBeanContext) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanContext struct {
	value *PageBeanContext
	isSet bool
}

func (v NullablePageBeanContext) Get() *PageBeanContext {
	return v.value
}

func (v *NullablePageBeanContext) Set(val *PageBeanContext) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanContext) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanContext) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanContext(val *PageBeanContext) *NullablePageBeanContext {
	return &NullablePageBeanContext{value: val, isSet: true}
}

func (v NullablePageBeanContext) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanContext) UnmarshalJSON(src []byte) error {
	v.isSet = true
