...
// checks if the PageOfStatuses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageOfStatuses{}

// PageOfStatuses struct for PageOfStatuses
...
// SetValues gets a reference to the given []JiraStatus and assigns it to the Values field.
func (o *PageOfStatuses) SetValues(v []JiraStatus) {
	o.Values = v
}

func (o PageOfStatuses) MarshalJSON() ([]byte, error) {
...
func (o PageOfStatuses) ToMap() (map[string]interface{}, error) {
...
type NullablePageOfStatuses struct {
	value *PageOfStatuses
	isSet bool
}

func (v NullablePageOfStatuses) Get() *PageOfStatuses {
	return v.value
}

func (v *NullablePageOfStatuses) Set(val *PageOfStatuses) {
	v.value = val
	v.isSet = true
}

func (v NullablePageOfStatuses) IsSet() bool {
	return v.isSet
}

func (v *NullablePageOfStatuses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageOfStatuses(val *PageOfStatuses) *NullablePageOfStatuses {
	return &NullablePageOfStatuses{value: val, isSet: true}
}

func (v NullablePageOfStatuses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageOfStatuses) UnmarshalJSON(src []byte) error {
	v.isSet = true
