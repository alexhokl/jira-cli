...
// checks if the PageBeanFieldConfigurationIssueTypeItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanFieldConfigurationIssueTypeItem{}
...
func NewPageBeanFieldConfigurationIssueTypeItem() *PageBeanFieldConfigurationIssueTypeItem {
	this := PageBeanFieldConfigurationIssueTypeItem{}
	return &this
}
...
func (o *PageBeanFieldConfigurationIssueTypeItem) GetValues() []FieldConfigurationIssueTypeItem {
	if o == nil || IsNil(o.Values) {
		var ret []FieldConfigurationIssueTypeItem
		return ret
	}
	return o.Values
}
...
// SetValues gets a reference to the given []FieldConfigurationIssueTypeItem and assigns it to the Values field.
func (o *PageBeanFieldConfigurationIssueTypeItem) SetValues(v []FieldConfigurationIssueTypeItem) {
	o.Values = v
}

func (o PageBeanFieldConfigurationIssueTypeItem) MarshalJSON() ([]byte, error) {
...
func (o PageBeanFieldConfigurationIssueTypeItem) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanFieldConfigurationIssueTypeItem struct {
	value *PageBeanFieldConfigurationIssueTypeItem
	isSet bool
}

func (v NullablePageBeanFieldConfigurationIssueTypeItem) Get() *PageBeanFieldConfigurationIssueTypeItem {
	return v.value
}

func (v *NullablePageBeanFieldConfigurationIssueTypeItem) Set(val *PageBeanFieldConfigurationIssueTypeItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanFieldConfigurationIssueTypeItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanFieldConfigurationIssueTypeItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanFieldConfigurationIssueTypeItem(val *PageBeanFieldConfigurationIssueTypeItem) *NullablePageBeanFieldConfigurationIssueTypeItem {
	return &NullablePageBeanFieldConfigurationIssueTypeItem{value: val, isSet: true}
}

func (v NullablePageBeanFieldConfigurationIssueTypeItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanFieldConfigurationIssueTypeItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
