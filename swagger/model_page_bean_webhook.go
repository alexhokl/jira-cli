...
// checks if the PageBeanWebhook type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanWebhook{}
...
// SetValues gets a reference to the given []Webhook and assigns it to the Values field.
func (o *PageBeanWebhook) SetValues(v []Webhook) {
	o.Values = v
}

func (o PageBeanWebhook) MarshalJSON() ([]byte, error) {
...
func (o PageBeanWebhook) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanWebhook struct {
	value *PageBeanWebhook
	isSet bool
}

func (v NullablePageBeanWebhook) Get() *PageBeanWebhook {
	return v.value
}

func (v *NullablePageBeanWebhook) Set(val *PageBeanWebhook) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanWebhook) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanWebhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanWebhook(val *PageBeanWebhook) *NullablePageBeanWebhook {
	return &NullablePageBeanWebhook{value: val, isSet: true}
}

func (v NullablePageBeanWebhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanWebhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
