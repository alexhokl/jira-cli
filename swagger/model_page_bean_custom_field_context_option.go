...
// checks if the PageBeanCustomFieldContextOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanCustomFieldContextOption{}
...
func NewPageBeanCustomFieldContextOption() *PageBeanCustomFieldContextOption {
	this := PageBeanCustomFieldContextOption{}
	return &this
}
...
// SetValues gets a reference to the given []CustomFieldContextOption and assigns it to the Values field.
func (o *PageBeanCustomFieldContextOption) SetValues(v []CustomFieldContextOption) {
	o.Values = v
}

func (o PageBeanCustomFieldContextOption) MarshalJSON() ([]byte, error) {
...
func (o PageBeanCustomFieldContextOption) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanCustomFieldContextOption struct {
	value *PageBeanCustomFieldContextOption
	isSet bool
}

func (v NullablePageBeanCustomFieldContextOption) Get() *PageBeanCustomFieldContextOption {
	return v.value
}

func (v *NullablePageBeanCustomFieldContextOption) Set(val *PageBeanCustomFieldContextOption) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanCustomFieldContextOption) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanCustomFieldContextOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanCustomFieldContextOption(val *PageBeanCustomFieldContextOption) *NullablePageBeanCustomFieldContextOption {
	return &NullablePageBeanCustomFieldContextOption{value: val, isSet: true}
}

func (v NullablePageBeanCustomFieldContextOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanCustomFieldContextOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
