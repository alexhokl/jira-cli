...
// checks if the PageBeanIssueTypeScreenSchemesProjects type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanIssueTypeScreenSchemesProjects{}
...
func NewPageBeanIssueTypeScreenSchemesProjects() *PageBeanIssueTypeScreenSchemesProjects {
	this := PageBeanIssueTypeScreenSchemesProjects{}
	return &this
}
...
func (o *PageBeanIssueTypeScreenSchemesProjects) GetValues() []IssueTypeScreenSchemesProjects {
	if o == nil || IsNil(o.Values) {
		var ret []IssueTypeScreenSchemesProjects
		return ret
	}
	return o.Values
}
...
// SetValues gets a reference to the given []IssueTypeScreenSchemesProjects and assigns it to the Values field.
func (o *PageBeanIssueTypeScreenSchemesProjects) SetValues(v []IssueTypeScreenSchemesProjects) {
	o.Values = v
}

func (o PageBeanIssueTypeScreenSchemesProjects) MarshalJSON() ([]byte, error) {
...
func (o PageBeanIssueTypeScreenSchemesProjects) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanIssueTypeScreenSchemesProjects struct {
	value *PageBeanIssueTypeScreenSchemesProjects
	isSet bool
}

func (v NullablePageBeanIssueTypeScreenSchemesProjects) Get() *PageBeanIssueTypeScreenSchemesProjects {
	return v.value
}

func (v *NullablePageBeanIssueTypeScreenSchemesProjects) Set(val *PageBeanIssueTypeScreenSchemesProjects) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanIssueTypeScreenSchemesProjects) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanIssueTypeScreenSchemesProjects) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanIssueTypeScreenSchemesProjects(val *PageBeanIssueTypeScreenSchemesProjects) *NullablePageBeanIssueTypeScreenSchemesProjects {
	return &NullablePageBeanIssueTypeScreenSchemesProjects{value: val, isSet: true}
}

func (v NullablePageBeanIssueTypeScreenSchemesProjects) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanIssueTypeScreenSchemesProjects) UnmarshalJSON(src []byte) error {
	v.isSet = true
