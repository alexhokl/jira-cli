...
// checks if the PageBeanNotificationSchemeAndProjectMappingJsonBean type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanNotificationSchemeAndProjectMappingJsonBean{}
...
func NewPageBeanNotificationSchemeAndProjectMappingJsonBean() *PageBeanNotificationSchemeAndProjectMappingJsonBean {
	this := PageBeanNotificationSchemeAndProjectMappingJsonBean{}
	return &this
}
...
func (o *PageBeanNotificationSchemeAndProjectMappingJsonBean) GetValues() []NotificationSchemeAndProjectMappingJsonBean {
	if o == nil || IsNil(o.Values) {
		var ret []NotificationSchemeAndProjectMappingJsonBean
		return ret
	}
	return o.Values
}
...
// SetValues gets a reference to the given []NotificationSchemeAndProjectMappingJsonBean and assigns it to the Values field.
func (o *PageBeanNotificationSchemeAndProjectMappingJsonBean) SetValues(v []NotificationSchemeAndProjectMappingJsonBean) {
	o.Values = v
}

func (o PageBeanNotificationSchemeAndProjectMappingJsonBean) MarshalJSON() ([]byte, error) {
...
func (o PageBeanNotificationSchemeAndProjectMappingJsonBean) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanNotificationSchemeAndProjectMappingJsonBean struct {
	value *PageBeanNotificationSchemeAndProjectMappingJsonBean
	isSet bool
}

func (v NullablePageBeanNotificationSchemeAndProjectMappingJsonBean) Get() *PageBeanNotificationSchemeAndProjectMappingJsonBean {
	return v.value
}

func (v *NullablePageBeanNotificationSchemeAndProjectMappingJsonBean) Set(val *PageBeanNotificationSchemeAndProjectMappingJsonBean) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanNotificationSchemeAndProjectMappingJsonBean) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanNotificationSchemeAndProjectMappingJsonBean) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanNotificationSchemeAndProjectMappingJsonBean(val *PageBeanNotificationSchemeAndProjectMappingJsonBean) *NullablePageBeanNotificationSchemeAndProjectMappingJsonBean {
	return &NullablePageBeanNotificationSchemeAndProjectMappingJsonBean{value: val, isSet: true}
}

func (v NullablePageBeanNotificationSchemeAndProjectMappingJsonBean) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanNotificationSchemeAndProjectMappingJsonBean) UnmarshalJSON(src []byte) error {
	v.isSet = true
