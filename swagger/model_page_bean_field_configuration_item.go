...
// checks if the PageBeanFieldConfigurationItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanFieldConfigurationItem{}
...
func NewPageBeanFieldConfigurationItem() *PageBeanFieldConfigurationItem {
	this := PageBeanFieldConfigurationItem{}
	return &this
}
...
// SetValues gets a reference to the given []FieldConfigurationItem and assigns it to the Values field.
func (o *PageBeanFieldConfigurationItem) SetValues(v []FieldConfigurationItem) {
	o.Values = v
}

func (o PageBeanFieldConfigurationItem) MarshalJSON() ([]byte, error) {
...
func (o PageBeanFieldConfigurationItem) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanFieldConfigurationItem struct {
	value *PageBeanFieldConfigurationItem
	isSet bool
}

func (v NullablePageBeanFieldConfigurationItem) Get() *PageBeanFieldConfigurationItem {
	return v.value
}

func (v *NullablePageBeanFieldConfigurationItem) Set(val *PageBeanFieldConfigurationItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanFieldConfigurationItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanFieldConfigurationItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanFieldConfigurationItem(val *PageBeanFieldConfigurationItem) *NullablePageBeanFieldConfigurationItem {
	return &NullablePageBeanFieldConfigurationItem{value: val, isSet: true}
}

func (v NullablePageBeanFieldConfigurationItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanFieldConfigurationItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
