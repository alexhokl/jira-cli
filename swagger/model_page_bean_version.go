...
// checks if the PageBeanVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanVersion{}
...
func (o PageBeanVersion) MarshalJSON() ([]byte, error) {
...
func (o PageBeanVersion) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanVersion struct {
	value *PageBeanVersion
	isSet bool
}

func (v NullablePageBeanVersion) Get() *PageBeanVersion {
	return v.value
}

func (v *NullablePageBeanVersion) Set(val *PageBeanVersion) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanVersion) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanVersion(val *PageBeanVersion) *NullablePageBeanVersion {
	return &NullablePageBeanVersion{value: val, isSet: true}
}

func (v NullablePageBeanVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
