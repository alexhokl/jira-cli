...
// checks if the PageBeanComponentWithIssueCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanComponentWithIssueCount{}
...
func NewPageBeanComponentWithIssueCount() *PageBeanComponentWithIssueCount {
	this := PageBeanComponentWithIssueCount{}
	return &this
}
...
func (o *PageBeanComponentWithIssueCount) GetValues() []ComponentWithIssueCount {
	if o == nil || IsNil(o.Values) {
		var ret []ComponentWithIssueCount
		return ret
	}
	return o.Values
}
...
// SetValues gets a reference to the given []ComponentWithIssueCount and assigns it to the Values field.
func (o *PageBeanComponentWithIssueCount) SetValues(v []ComponentWithIssueCount) {
	o.Values = v
}

func (o PageBeanComponentWithIssueCount) MarshalJSON() ([]byte, error) {
...
func (o PageBeanComponentWithIssueCount) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanComponentWithIssueCount struct {
	value *PageBeanComponentWithIssueCount
	isSet bool
}

func (v NullablePageBeanComponentWithIssueCount) Get() *PageBeanComponentWithIssueCount {
	return v.value
}

func (v *NullablePageBeanComponentWithIssueCount) Set(val *PageBeanComponentWithIssueCount) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanComponentWithIssueCount) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanComponentWithIssueCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanComponentWithIssueCount(val *PageBeanComponentWithIssueCount) *NullablePageBeanComponentWithIssueCount {
	return &NullablePageBeanComponentWithIssueCount{value: val, isSet: true}
}

func (v NullablePageBeanComponentWithIssueCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanComponentWithIssueCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
