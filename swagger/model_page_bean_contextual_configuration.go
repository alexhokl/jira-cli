...
// checks if the PageBeanContextualConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanContextualConfiguration{}
...
func NewPageBeanContextualConfiguration() *PageBeanContextualConfiguration {
	this := PageBeanContextualConfiguration{}
	return &this
}
...
// SetValues gets a reference to the given []ContextualConfiguration and assigns it to the Values field.
func (o *PageBeanContextualConfiguration) SetValues(v []ContextualConfiguration) {
	o.Values = v
}

func (o PageBeanContextualConfiguration) MarshalJSON() ([]byte, error) {
...
func (o PageBeanContextualConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanContextualConfiguration struct {
	value *PageBeanContextualConfiguration
	isSet bool
}

func (v NullablePageBeanContextualConfiguration) Get() *PageBeanContextualConfiguration {
	return v.value
}

func (v *NullablePageBeanContextualConfiguration) Set(val *PageBeanContextualConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanContextualConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanContextualConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanContextualConfiguration(val *PageBeanContextualConfiguration) *NullablePageBeanContextualConfiguration {
	return &NullablePageBeanContextualConfiguration{value: val, isSet: true}
}

func (v NullablePageBeanContextualConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanContextualConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
