...
// checks if the PageBeanCustomFieldContextDefaultValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanCustomFieldContextDefaultValue{}
...
func NewPageBeanCustomFieldContextDefaultValue() *PageBeanCustomFieldContextDefaultValue {
	this := PageBeanCustomFieldContextDefaultValue{}
	return &this
}
...
// SetValues gets a reference to the given []CustomFieldContextDefaultValue and assigns it to the Values field.
func (o *PageBeanCustomFieldContextDefaultValue) SetValues(v []CustomFieldContextDefaultValue) {
	o.Values = v
}

func (o PageBeanCustomFieldContextDefaultValue) MarshalJSON() ([]byte, error) {
...
func (o PageBeanCustomFieldContextDefaultValue) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanCustomFieldContextDefaultValue struct {
	value *PageBeanCustomFieldContextDefaultValue
	isSet bool
}

func (v NullablePageBeanCustomFieldContextDefaultValue) Get() *PageBeanCustomFieldContextDefaultValue {
	return v.value
}

func (v *NullablePageBeanCustomFieldContextDefaultValue) Set(val *PageBeanCustomFieldContextDefaultValue) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanCustomFieldContextDefaultValue) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanCustomFieldContextDefaultValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanCustomFieldContextDefaultValue(val *PageBeanCustomFieldContextDefaultValue) *NullablePageBeanCustomFieldContextDefaultValue {
	return &NullablePageBeanCustomFieldContextDefaultValue{value: val, isSet: true}
}

func (v NullablePageBeanCustomFieldContextDefaultValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanCustomFieldContextDefaultValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
