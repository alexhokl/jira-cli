...
// checks if the PageBeanIssueSecurityLevelMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanIssueSecurityLevelMember{}
...
func NewPageBeanIssueSecurityLevelMember() *PageBeanIssueSecurityLevelMember {
	this := PageBeanIssueSecurityLevelMember{}
	return &this
}
...
func (o *PageBeanIssueSecurityLevelMember) GetValues() []IssueSecurityLevelMember {
	if o == nil || IsNil(o.Values) {
		var ret []IssueSecurityLevelMember
		return ret
	}
	return o.Values
}
...
// SetValues gets a reference to the given []IssueSecurityLevelMember and assigns it to the Values field.
func (o *PageBeanIssueSecurityLevelMember) SetValues(v []IssueSecurityLevelMember) {
	o.Values = v
}

func (o PageBeanIssueSecurityLevelMember) MarshalJSON() ([]byte, error) {
...
func (o PageBeanIssueSecurityLevelMember) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanIssueSecurityLevelMember struct {
	value *PageBeanIssueSecurityLevelMember
	isSet bool
}

func (v NullablePageBeanIssueSecurityLevelMember) Get() *PageBeanIssueSecurityLevelMember {
	return v.value
}

func (v *NullablePageBeanIssueSecurityLevelMember) Set(val *PageBeanIssueSecurityLevelMember) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanIssueSecurityLevelMember) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanIssueSecurityLevelMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanIssueSecurityLevelMember(val *PageBeanIssueSecurityLevelMember) *NullablePageBeanIssueSecurityLevelMember {
	return &NullablePageBeanIssueSecurityLevelMember{value: val, isSet: true}
}

func (v NullablePageBeanIssueSecurityLevelMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanIssueSecurityLevelMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
