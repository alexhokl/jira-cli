...
// checks if the IssueEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IssueEvent{}
...
func (o IssueEvent) ToMap() (map[string]interface{}, error) {
