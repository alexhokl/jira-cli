...
// checks if the IssueTypeDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IssueTypeDetails{}
...
func (o IssueTypeDetails) MarshalJSON() ([]byte, error) {
...
func (o IssueTypeDetails) ToMap() (map[string]interface{}, error) {
...
type NullableIssueTypeDetails struct {
	value *IssueTypeDetails
	isSet bool
}

func (v NullableIssueTypeDetails) Get() *IssueTypeDetails {
	return v.value
}

func (v *NullableIssueTypeDetails) Set(val *IssueTypeDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableIssueTypeDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableIssueTypeDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIssueTypeDetails(val *IssueTypeDetails) *NullableIssueTypeDetails {
	return &NullableIssueTypeDetails{value: val, isSet: true}
}

func (v NullableIssueTypeDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIssueTypeDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
