...
// checks if the PageBeanField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageBeanField{}
...
// SetValues gets a reference to the given []Field and assigns it to the Values field.
func (o *PageBeanField) SetValues(v []Field) {
	o.Values = v
}

func (o PageBeanField) MarshalJSON() ([]byte, error) {
...
func (o PageBeanField) ToMap() (map[string]interface{}, error) {
...
type NullablePageBeanField struct {
	value *PageBeanField
	isSet bool
}

func (v NullablePageBeanField) Get() *PageBeanField {
	return v.value
}

func (v *NullablePageBeanField) Set(val *PageBeanField) {
	v.value = val
	v.isSet = true
}

func (v NullablePageBeanField) IsSet() bool {
	return v.isSet
}

func (v *NullablePageBeanField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageBeanField(val *PageBeanField) *NullablePageBeanField {
	return &NullablePageBeanField{value: val, isSet: true}
}

func (v NullablePageBeanField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageBeanField) UnmarshalJSON(src []byte) error {
	v.isSet = true
