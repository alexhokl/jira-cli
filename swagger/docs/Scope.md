...
------------ | ------------- | ------------- | -------------
**Project** | Pointer to [**ProjectDetails**](ProjectDetails.md) | The project the item has scope in. | [optional] [readonly] 
...
`func (o *Scope) GetProject() ProjectDetails`

GetProject returns the Project field if non-nil, zero value otherwise.

### GetProjectOk

`func (o *Scope) GetProjectOk() (*ProjectDetails, bool)`
...
`func (o *Scope) SetProject(v ProjectDetails)`
