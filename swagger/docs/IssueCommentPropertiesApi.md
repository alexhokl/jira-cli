...
> DeleteCommentProperty(ctx, commentId, propertyKey)
...
# **GetCommentProperty**
> EntityProperty GetCommentProperty(ctx, commentId, propertyKey)
...
> PropertyKeys GetCommentPropertyKeys(ctx, commentId)
...
# **SetCommentProperty**
> Object SetCommentProperty(ctx, body, commentId, propertyKey)
