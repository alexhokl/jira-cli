...
------------ | ------------- | ------------- | -------------
**Changelog** | Pointer to [**IssueBeanChangelog**](IssueBeanChangelog.md) |  | [optional] 
**Editmeta** | Pointer to [**IssueBeanEditmeta**](IssueBeanEditmeta.md) |  | [optional] 
...
**FieldsToInclude** | Pointer to [**IssueBeanFieldsToInclude**](IssueBeanFieldsToInclude.md) |  | [optional] 
...
**Schema** | Pointer to [**map[string]IssueBeanSchemaValue**](IssueBeanSchemaValue.md) | The schema describing each field present on the issue. | [optional] [readonly] 
**Self** | Pointer to **string** | The URL of the issue details. | [optional] [readonly] 
**Transitions** | Pointer to [**[]IssueBeanTransitionsInner**](IssueBeanTransitionsInner.md) | The transitions that can be performed on the issue. | [optional] [readonly] 
...
`func (o *IssueBean) GetChangelog() IssueBeanChangelog`

GetChangelog returns the Changelog field if non-nil, zero value otherwise.

### GetChangelogOk

`func (o *IssueBean) GetChangelogOk() (*IssueBeanChangelog, bool)`
...
`func (o *IssueBean) SetChangelog(v IssueBeanChangelog)`
...
`func (o *IssueBean) GetEditmeta() IssueBeanEditmeta`

GetEditmeta returns the Editmeta field if non-nil, zero value otherwise.

### GetEditmetaOk

`func (o *IssueBean) GetEditmetaOk() (*IssueBeanEditmeta, bool)`
...
`func (o *IssueBean) SetEditmeta(v IssueBeanEditmeta)`
...
`func (o *IssueBean) GetFieldsToInclude() IssueBeanFieldsToInclude`

GetFieldsToInclude returns the FieldsToInclude field if non-nil, zero value otherwise.

### GetFieldsToIncludeOk

`func (o *IssueBean) GetFieldsToIncludeOk() (*IssueBeanFieldsToInclude, bool)`
...
`func (o *IssueBean) SetFieldsToInclude(v IssueBeanFieldsToInclude)`
...
`func (o *IssueBean) GetSchema() map[string]IssueBeanSchemaValue`

GetSchema returns the Schema field if non-nil, zero value otherwise.

### GetSchemaOk

`func (o *IssueBean) GetSchemaOk() (*map[string]IssueBeanSchemaValue, bool)`
...
`func (o *IssueBean) SetSchema(v map[string]IssueBeanSchemaValue)`
...
`func (o *IssueBean) GetTransitions() []IssueBeanTransitionsInner`

GetTransitions returns the Transitions field if non-nil, zero value otherwise.

### GetTransitionsOk

`func (o *IssueBean) GetTransitionsOk() (*[]IssueBeanTransitionsInner, bool)`
...
`func (o *IssueBean) SetTransitions(v []IssueBeanTransitionsInner)`
