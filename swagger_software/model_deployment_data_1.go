...
// checks if the DeploymentData1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentData1{}

// DeploymentData1 Data related to a specific deployment in a specific environment that the deployment is present in. Must specify one of `issueKeys` or `associations`. 
type DeploymentData1 struct {
...
type _DeploymentData1 DeploymentData1
...
func (o DeploymentData1) MarshalJSON() ([]byte, error) {
...
func (o DeploymentData1) ToMap() (map[string]interface{}, error) {
...
func (o *DeploymentData1) UnmarshalJSON(data []byte) (err error) {
	...
	varDeploymentData1 := _DeploymentData1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeploymentData1)

	if err != nil {
		return err
	}

	*o = DeploymentData1(varDeploymentData1)

	return err
}

type NullableDeploymentData1 struct {
	value *DeploymentData1
	isSet bool
}

func (v NullableDeploymentData1) Get() *DeploymentData1 {
	return v.value
}

func (v *NullableDeploymentData1) Set(val *DeploymentData1) {
	v.value = val
	v.isSet = true
}

func (v NullableDeploymentData1) IsSet() bool {
	return v.isSet
}

func (v *NullableDeploymentData1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeploymentData1(val *DeploymentData1) *NullableDeploymentData1 {
	return &NullableDeploymentData1{value: val, isSet: true}
}

func (v NullableDeploymentData1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeploymentData1) UnmarshalJSON(src []byte) error {
	v.isSet = true
