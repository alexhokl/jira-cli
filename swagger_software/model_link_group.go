...
type LinkGroup struct {
	...
	Header *LinkGroupHeader `json:"header,omitempty"`
	Id *string `json:"id,omitempty"`
	Links []LinkGroupHeader `json:"links,omitempty"`
...
// SetHeader gets a reference to the given LinkGroupHeader and assigns it to the Header field.
...
// SetLinks gets a reference to the given []LinkGroupHeader and assigns it to the Links field.
